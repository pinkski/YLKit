...
#import "NSDictionary+YLAdd.h"
#import "NSString+YLAdd.h"
#import "NSData+YLAdd.h"
#import "YLKitMacro.h"

YYSYNTH_DUMMY_CLASS(NSDictionary_YLAdd)


@interface _YLXMLDictionaryParser : NSObject <NSXMLParserDelegate>
@end

@implementation _YLXMLDictionaryParser {
...
@implementation NSDictionary (YLAdd)
...
+ (NSDictionary *)dictionaryWithXML:(id)xml {
    _YLXMLDictionaryParser *parser = nil;
    if ([xml isKindOfClass:[NSString class]]) {
        parser = [[_YLXMLDictionaryParser alloc] initWithString:xml];
    } else if ([xml isKindOfClass:[NSData class]]) {
        parser = [[_YLXMLDictionaryParser alloc] initWithData:xml];
    }
