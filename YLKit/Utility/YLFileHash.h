 ...
 */
+ (nullable YLFileHash *)hashForFile:(NSString *)filePath types:(YYFileHashType)types;
...
/**
 ...
 @return File hash result, or nil when an error occurs.
 */
+ (nullable YLFileHash *)hashForFile:(NSString *)filePath
