 ...
 */
+ (NSArray<YLKeychainItem *> *)selectItems:(YLKeychainItem *)item error:(NSError **)error;
+ (NSArray<YLKeychainItem *> *)selectItems:(YLKeychainItem *)item;
 ...
 */
@interface YLKeychainItem : NSObject <NSCopying>
