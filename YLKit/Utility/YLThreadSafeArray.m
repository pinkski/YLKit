...
#import "YLThreadSafeArray.h"
#import "NSArray+YLAdd.h"
...
@implementation YLThreadSafeArray {
    NSMutableArray *_arr;
...
- (BOOL)isEqualToArray:(NSArray *)otherArray {
    ...
    if ([otherArray isKindOfClass:YLThreadSafeArray.class]) {
        YLThreadSafeArray *other = (id)otherArray;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:YLThreadSafeArray.class]) {
        YLThreadSafeArray *other = object;
        BOOL isEqual;
        dispatch_semaphore_wait(_lock, DISPATCH_TIME_FOREVER);
        dispatch_semaphore_wait(other->_lock, DISPATCH_TIME_FOREVER);
