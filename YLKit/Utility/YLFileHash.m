...
@implementation YLFileHash

+ (YLFileHash *)hashForFile:(NSString *)filePath types:(YYFileHashType)types {
    return [self hashForFile:filePath types:types usingBlock:nil];
}

+ (YLFileHash *)hashForFile:(NSString *)filePath types:(YYFileHashType)types usingBlock:(void(^)(UInt64 totalSize, UInt64 processedSize, BOOL *stop))block {
    YLFileHash *hash = nil;
